  ...
  class FractalBranchTree {
    ...
    setBranchGradient(depth, branchLen) {
      ...
      switch(this.colorTheme) {
        ...
        case 'eucalyptus':
          ...
          break;
        case 'ebony':
          colStart = lerpColor(color(20, 20, 24), color(85, 90, 100), progressStart);
          colEnd = lerpColor(color(20, 20, 24), color(85, 90, 100), progressEnd);
          break;
        case 'birch':
          colStart = lerpColor(color(55, 55, 60), color(230, 235, 242), progressStart);
          colEnd = lerpColor(color(55, 55, 60), color(230, 235, 242), progressEnd);
          break;
        case 'mahogany':
          colStart = lerpColor(color(45, 18, 18), color(175, 70, 50), progressStart);
          colEnd = lerpColor(color(45, 18, 18), color(175, 70, 50), progressEnd);
          break;
        case 'amber':
          colStart = lerpColor(color(40, 25, 15), color(217, 119, 6), progressStart);
          colEnd = lerpColor(color(40, 25, 15), color(217, 119, 6), progressEnd);
          break;
        case 'cyberpunk':
        default:
    ...
    getBranchColorAtDepth(depth) {
      ...
      if (this.colorTheme === 'sakura') {
        ...
        col = lerpColor(color(20, 20, 24), color(85, 90, 100), progress);
      } else if (this.colorTheme === 'birch') {
        col = lerpColor(color(55, 55, 60), color(230, 235, 242), progress);
      } else if (this.colorTheme === 'mahogany') {
        col = lerpColor(color(45, 18, 18), color(175, 70, 50), progress);
      } else if (this.colorTheme === 'amber') {
        col = lerpColor(color(40, 25, 15), color(217, 119, 6), progress);
      } else {
